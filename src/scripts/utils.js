...
export const degreesToRad = function(degrees) {
  return degrees / 180 * Math.PI;
}
export const radToDegrees = function(radians) {
...
// Returns a boolean
export const circleCollision = function(c0, c1) {
  return  utils.distance(c0, c1) <= c0.radius + c1.radius;
}
// Collision between a cirlce and a point
// Returns a boolean
export const circlePointCollision = function(x, y, circle) {
  return  utils.distanceXY(x, y, circle.x, circle.y) < circle.radius;
}
// Point in a line
// Returns a boolean
export const pointInRect = function(x, y, rect) {
...
export const rangeIntersect = function(min0, max0, min1, max1) {
  return  Math.max(min0, max0) >= Math.min(min1, max1) && 
          Math.min(min0, max0) <= Math.max(min1, max1);
}
// Checks if two straight lines intersect
export const rectIntersect = function(r0, r1) {
  return  utils.rangeIntersect(r0.x, r0.x + r0.width, r1.x, r1.x + r1.width) &&
          utils.rangeIntersect(r0.y, r0.y + r0.height, r1.y, r1.y + r1.height);
}

export const quadraticBezier = function(p0, p1, p2, t, pFinal) {
  pFinal = pFinal || {};
...
export const cubicBezier = function(p0, p1, p2, p3, t, pFinal) {
  pFinal =  pFinal || {};
...
export const multiCurve = function(points, context) {
  let p0, p1, midX, midY;
